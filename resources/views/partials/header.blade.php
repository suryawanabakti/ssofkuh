    ...
    <div class="container-xl">
        ...
        <div class="navbar-nav flex-row order-md-last">
            ...
            <div class="nav-item d-none d-md-flex me-3">
                <div class="btn-list">
                    @guest
                        <a href="/login" class="nav-link px-0 " title="Enable light mode">
                            <!-- Download SVG icon from http://tabler-icons.io/i/sun -->
                            Login As Admin
                        </a>
                    @endguest
        ...
        <div class="navbar">
            <div class="container-xl">
                <ul class="navbar-nav">
                    ...
                    @endrole
                    <li class="nav-item {{ request()->is('connected*') ? 'active' : '' }}">
                        <a class="nav-link" href="/connected">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
